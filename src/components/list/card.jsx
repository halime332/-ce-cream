...
const Card = ({item}) => {
  ...
  return (
    <div className='bg-black/20 border border-white/50 rounded-[24px] pl-[10px] pr-[20px] 
      py-[30px] flex gap-[15px] lg:gap-[30px]' data-testid="list-card">
        ...
        <div className='flex-1'>
            ...
            <div className='mt-5 flex justify-between'>
                ...
                <button onClick={handleBasket} className={`border py-1 px-3 rounded-md hover:bg-white/30 transition
                    ${!selectedType && "invisible"}`} >Sepete Ekle</button>
            </div>
        </div>
    </div>
  )
